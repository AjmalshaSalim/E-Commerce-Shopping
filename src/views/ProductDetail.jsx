  ...
  return (
    ...
    <div className="flex flex-col lg:flex-row font-josefin-sans" >
      ...
      <div className="lg:w-1/2 p-4">
        ...
        <img src={currentImage} alt="Product" className="h-auto lg: object-contain m-auto w-80" />
        </div>
      ...
      <div className="lg:w-1/2 p-4">
       <div className=" h-4/6">
       <h1 className="text-3xl mb-4 pt-10">Samsung GS-31 Headphone Bluetooth</h1>
        <p className="text-gray-600 mb-4 text-wrap">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam eget nisl a nibh posuere
          rhoncus. Lorem, ipsum dolor sit amet consectetur adipisicing elit. Ratione atque optio 
          perferendis nobis voluptate quaerat accusantium sequi, labore dolore quo sint voluptatibus
           corrupti error aperiam fugit maiores voluptatum eius debitis!
           Lorem ipsum dolor, sit amet consectetur adipisicing elit. Dolore voluptas at cum magnam ut reprehenderit illum blanditiis, repellendus in accusamus?
        </p>
       </div>
        <div className="">
